...
void USSGA_Slash::InputReleased(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo,
                                const FGameplayAbilityActivationInfo ActivationInfo)
{
	Super::InputReleased(Handle, ActorInfo, ActivationInfo);
}

void USSGA_Slash::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo,
                                  const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
	...
	//InputTask->OnPress.AddDynamic(this, &USSGA_Slash::OnInputPressed);
...
void USSGA_Slash::EndAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo,
...
void USSGA_Slash::ApplyCost(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo,
                            const FGameplayAbilityActivationInfo ActivationInfo) const
{
	Super::ApplyCost(Handle, ActorInfo, ActivationInfo);
}

void USSGA_Slash::AbilityEventReceived(FGameplayTag EventTag, FGameplayEventData Payload)
{
	//AnimNotify State Liking
}

void USSGA_Slash::SetComboCheckTimer()
{
	...
	{
		GetWorld()->GetTimerManager().SetTimer(ComboTimerHandle, this, &USSGA_Slash::ComboCheck, ComboEffectiveTime, false);
	}
}

void USSGA_Slash::ComboCheck()
{
	ComboTimerHandle.Invalidate();
...
//void USSGA_Slash::OnInputPressed(float TimeWaited)
//{
